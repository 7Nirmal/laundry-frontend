...
import SubTotal from '../../components/navbar/subtotal/Subtotal';
        ...
        <div className='container cart-wrapper'>
            ...
            <div className='cart-right'>
                <div className='schedule-btn-div'>
                    <button className='pickupBtn' onClick={()=>{navigate("/schedulePickup")}}><AccessTimeOutlinedIcon /> Schedule Pickup</button>
                </div>
